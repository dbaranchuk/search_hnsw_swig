...
SWIGINTERN PyObject *_wrap_find_nearest(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOO:find_nearest",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7)) SWIG_fail;
  {
  ...
  if (!(SWIG_IsOK((res16 = SWIG_ConvertPtr(obj5,SWIG_as_voidptrptr(&arg16),SWIGTYPE_p_int,0))))) {
    int val; 
    int ecode = SWIG_AsVal_int(obj5, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "find_nearest" "', argument " "16"" of type '" "int""'");
    }
    temp16 = (int)(val);
    arg16 = &temp16;
    res16 = SWIG_AddTmpMask(ecode);
  }
  if (!(SWIG_IsOK((res17 = SWIG_ConvertPtr(obj6,SWIG_as_voidptrptr(&arg17),SWIGTYPE_p_int,0))))) {
    int val; 
    int ecode = SWIG_AsVal_int(obj6, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "find_nearest" "', argument " "17"" of type '" "int""'");
    }
    temp17 = (int)(val);
    arg17 = &temp17;
    res17 = SWIG_AddTmpMask(ecode);
  }
  if (!(SWIG_IsOK((res18 = SWIG_ConvertPtr(obj7,SWIG_as_voidptrptr(&arg18),SWIGTYPE_p_int,0))))) {
    int val; 
    int ecode = SWIG_AsVal_int(obj7, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "find_nearest" "', argument " "18"" of type '" "int""'");
    }
    temp18 = (int)(val);
    arg18 = &temp18;
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    find_nearest(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  ...
  if (SWIG_IsNewObj(res16)) free((char*)arg16);
  if (SWIG_IsNewObj(res17)) free((char*)arg17);
  if (SWIG_IsNewObj(res18)) free((char*)arg18);
  return resultobj;
fail:
  {
    if (is_new_object4 && array4)
