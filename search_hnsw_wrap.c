...
/*-----------------------------------------------
              @(target):= _search_hnsw.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__search_hnsw

#else
#  define SWIG_init    init_search_hnsw

#endif
#define SWIG_name    "_search_hnsw"
...
SWIGINTERN PyObject *_wrap_fvec_L2sqr(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:fvec_L2sqr",&obj0,&obj1,&obj2)) SWIG_fail;
  ...
  arg3 = (size_t)(val3);
  {
    ...
    result = (float)fvec_L2sqr((float const *)arg1,(float const *)arg2,arg3);
...
SWIGINTERN PyObject *_wrap_find_nearest(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int arg2 ;
  float *arg3 = (float *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOO:find_nearest",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  }
  {
    ...
    arg12 = (float*) array_data(array10);
  }
  {
    array13 = obj_to_array_no_conversion(obj4, NPY_INT);
    ...
    arg15 = (int*) array_data(array13);
  }
  {
    array16 = obj_to_array_no_conversion(obj5, NPY_INT);
    ...
    arg17 = (int) array_size(array16,1);
    arg18 = (int*) array_data(array16);
  }
  if (!(SWIG_IsOK((res19 = SWIG_ConvertPtr(obj6,SWIG_as_voidptrptr(&arg19),SWIGTYPE_p_int,0))))) {
    int val; 
    int ecode = SWIG_AsVal_int(obj6, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "find_nearest" "', argument " "19"" of type '" "int""'");
    }
    temp19 = (int)(val);
    arg19 = &temp19;
    res19 = SWIG_AddTmpMask(ecode);
  }
  if (!(SWIG_IsOK((res20 = SWIG_ConvertPtr(obj7,SWIG_as_voidptrptr(&arg20),SWIGTYPE_p_int,0))))) {
    int val; 
    int ecode = SWIG_AsVal_int(obj7, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "find_nearest" "', argument " "20"" of type '" "int""'");
    }
    temp20 = (int)(val);
    arg20 = &temp20;
    res20 = SWIG_AddTmpMask(ecode);
  }
  if (!(SWIG_IsOK((res21 = SWIG_ConvertPtr(obj8,SWIG_as_voidptrptr(&arg21),SWIGTYPE_p_int,0))))) {
    int val; 
    int ecode = SWIG_AsVal_int(obj8, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "find_nearest" "', argument " "21"" of type '" "int""'");
    }
    temp21 = (int)(val);
    arg21 = &temp21;
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    find_nearest(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20,arg21);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  ...
  if (SWIG_IsNewObj(res19)) free((char*)arg19);
  if (SWIG_IsNewObj(res20)) free((char*)arg20);
  if (SWIG_IsNewObj(res21)) free((char*)arg21);
  return resultobj;
fail:
  {
    if (is_new_object1 && array1)
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"fvec_L2sqr", _wrap_fvec_L2sqr, METH_VARARGS, NULL},
	 { (char *)"find_nearest", _wrap_find_nearest, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_unsigned_int = {"_p_unsigned_int", "unsigned int *|idx_t *", 0, 0, (void*)0, 0};
